...
public class JsonFileService : IJsonFileService
{
    ...
    public async Task CreateFileAsync()
    {
        ...
        try
        {
            ...
            {
                await File.WriteAllTextAsync(_options.FilePath, "{}");
    ...
    private async Task PerformRolloverAsync()
    {
        ...
        var rolledOverPath = Path.Combine(_options.RolloverDirectory, rolledOverFileName);
    ...
    private void EnsureDirectoriesExist()
    {
        try
        {
            ...
            {
                Directory.CreateDirectory(_options.RolloverDirectory);
